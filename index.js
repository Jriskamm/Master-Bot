...
client.on('guildCreate', guild => {
  ...
  .setDescription('To get started, join a voice channel and `/play` a song! You can use song names, video links, and playlist links. A full list of commands is available [here](https://docs.google.com/document/d/1cRUb67XddISl5qJEl4ag5aOAyMEHNBC9w_3t2LFvXrk/edit?usp=sharing) or by typing the command: `/help`. You can add me into your servers by [clicking on me](https://discord.com/oauth2/authorize?client_id=745140889755844680&permissions=8&redirect_uri=https%3A%2F%2Fdiscord.com%2Foauth2%2Fauthorize%3Fclient_id%3D745140889755844680%26scope%3Dbot%26permissions%3D3525704&response_type=code&scope=identify%20applications.commands%20bot%20email%20guilds). \n\nIf you have any questions or need help with Bunch, [click here](https://discord.gg/WkJGTekDZp) to join our support server!')
